        ...
        <div className="form">
          <form method="post" encType="multipart/form-data">
            ...
            >
              ...
              <option className="catoo" value="tech">
                tech
              </option>
              <option className="catoo" value="lifestyle">
                lifestyle
              </option>
              <option className="catoo" value="food">
                food
              </option>
              <option className="catoo" value="travelling">
                travelling
              </option>
            </select>
            ...
            {!pflag ? (
              <>
                <button
                  ...
                  className="btnsubt"
                >
                  {loading ? <PulseLoader color="#673636ff" size={5} /> : "Submit"}
                </button>
              </>
            ) : (
              <>

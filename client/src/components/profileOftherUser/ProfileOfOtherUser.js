...
function ProfileOfOtherUser() {
  ...
  return (
    <div className="ProfileOfOtherUser">
      ...
      {!user ? (
        <div className="followc cent" onClick={() => navigate("/auth")}>
          +FOLLOW
        </div>
      ) : (
        <>
          {!sc ? (
            <div className="followc cent" onClick={() => startfollowfun()}>
              +FOLLOW
            </div>
          ) : (
            <div className="followc cent" onClick={() => unfollowfun()}>
              FOLLOWING
            </div>
          )}
        </>
      ...
      <div className="follpage">
        <div className="following">Following: {folcd}</div>
        <div className="follower">Followers: {folc}</div>
      </div>
      <Footer />
    </div>
  );

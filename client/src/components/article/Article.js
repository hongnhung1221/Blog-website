...
function Article({ post, __id }) {
  ...
  const [formr, rform] = useState("");
  const [reportedata, setreported] = useState("Report");
        ...
        <div className="article_wrapper" id="123k">
          <div className="article">
            ...
            <span className="post_date">
              {formattedDate.toUpperCase()} | {post.category.toUpperCase()} | {view ? `${view}` + " views" : "0 view"} | {likec ? `${likec}` + " likes" : "0 like"}
            </span>
            <br />
